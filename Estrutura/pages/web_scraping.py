...
# * Criando abas para facilitar a locomoção do usuário
tab1, tab2, tab3, tab4 = st.tabs(['🌐 **Parâmetros das categorias**', '🛣️ **Elementos e XPATH**', '🗄️ **Armazenamento dos dados**', '📄 **Código Completo**'])
...
# -------------------------------
with tab1:
    st.title('🌐 Parâmetros das categorias')
...
with tab3:
    ...
    st.write('Após o script extrair os dados de todos os produtos de uma determinada categoria, ele os armazena em uma :green[**lista-dicionário**], convertendo-o para um :green[**Banco de Dados**] utilizando o :blue[**SQLite**]')
...
with botao3:
    if st.button(':red[***Visão Geral do Projeto***]', icon=':material/reply:', width='stretch'):
